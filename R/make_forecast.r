source('../R_HA/prepare_parameters.r')
source('../R_HA/fit_model.r')
source('../R_HA/forecast.r')
source('../R_HA/score_forecasts.r')




make_forecast <- function(timeseries_mat, shapes, day_of_forecast=NULL, fit_over=1000, timestep =1 ,  period_and_lag = c(5,7) ,interaction = c(1), distrib=1, fit_meth='vb') { 
